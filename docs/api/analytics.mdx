...
Новые endpoint-ы нужны для агрегированной аналитики и feedback по распознаваниям:
...
Допустимые значения `status`: `online`, `stale`, `offline`, `no_data`,
...
К новым endpoint-ам относятся данные, которых нет в старом CRUD API:
